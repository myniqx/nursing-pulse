    ...
    return NpSection(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.stackMd),
          _NotificationPreview(formattedTime: '04:32'),
        ],
      ),
    );
  }
...
class _NotificationPreview extends StatelessWidget {
  const _NotificationPreview({required this.formattedTime});
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.water_drop, color: AppColors.onPrimary, size: 20),
          ),
